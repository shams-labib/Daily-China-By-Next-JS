    ...
    <>
          ...
          <div className="fixed top-0 right-0 h-full w-[300px] bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="overflow-y-auto flex-1">
              ...
              <div className="p-4 bg-gray-50 grid grid-cols-2 gap-2 border-b">
                <button
                  onClick={handleAction}
                  className="flex items-center justify-center gap-2 bg-red-700 text-white p-2 rounded-lg text-sm"
                >
                  <UserPlus size={16} /> Register
                </button>
                <button
                  onClick={handleAction}
                  className="flex items-center justify-center gap-2 border border-red-700 text-red-700 p-2 rounded-lg text-sm"
                >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
          <div className="bg-white rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl border-t-4 border-red-600">
            ...
            <button
              ...
              className="w-full bg-red-700 text-white py-3 rounded-xl font-bold hover:bg-red-800 transition-all shadow-lg active:scale-95"
            >
              CLOSE
            </button>
          </div>
